...
namespace SEDC.NotesAPI.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public IActionResult Put([FromBody] User user)
        {
            ...
            return StatusCode(StatusCodes.Status204NoContent, "User successfully updated.");
        }
        ...
        public IActionResult Delete(int id)
        {
            ...
            return StatusCode(StatusCodes.Status204NoContent, "User successfully deleted. (Even though this msg probably won't appear :))");
        }
    }
}
